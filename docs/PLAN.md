...
- [ ] ADR-0015 三步实施：①声明式身份开关 + 如实披露（无密码学）②`probe keygen`
      ...
      prism 落地时与 ADR-0017 §3/§5/§7 修订一起执行；见 docs/adr/0025 Plan B。
